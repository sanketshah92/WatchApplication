 ...
 */
class HRWatchFace : CanvasWatchFaceService() {
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@HRWatchFace)
            ...
            val resources = this@HRWatchFace.resources
        ...
        private fun registerReceiver() {
            ...
            this@HRWatchFace.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@HRWatchFace.unregisterReceiver(mTimeZoneReceiver)
        }
